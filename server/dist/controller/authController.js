...
exports.login = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
    ...
    if (error || !data.session || !data.user) {
        ...
        if ((error === null || error === void 0 ? void 0 : error.code) === 'email_not_confirmed') {
            return next(new appError_1.AppError('Email not confirmed. Please check your inbox and confirm your email before logging in.', 401));
        }
