...
const msgRouter_1 = __importDefault(require("./routers/msgRouter"));
const conRouter_1 = __importDefault(require("./routers/conRouter"));
...
app.use("/api/v1/msgs", msgRouter_1.default);
app.use("/api/v1", conRouter_1.default);
// ##############################################################
// DATABASE CONNECTION
